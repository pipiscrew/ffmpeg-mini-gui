...
A small application doing the usual for `ffmpeg`.  
...
* 😕 [FFmpeg Batch AV Converter](https://ffmpeg-batch.sourceforge.io/) - csharp
* [qwinff](https://github.com/qwinff/qwinff) - c++
* [StaxRip](https://github.com/staxrip/staxrip) - vb.net
* [Axiom](https://github.com/MattMcManis/Axiom) - csharp
