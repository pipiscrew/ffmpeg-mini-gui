namespace ffmpeg_mini_gui
{
    partial class frmConvertImage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "The list accepts any image type (via drag && drop)";
            // 
            // cmbOutputFormat
            // 
            ...
            this.label2.Location = new System.Drawing.Point(94, 364);
            this.label2.Name = "label2";
            this.label2.Size = new System.Drawing.Size(263, 58);
            this.label2.TabIndex = 5;
            this.label2.Text = ".bmp, .dpx, .exr, .fits, .hdr, .png, .psd, .ppm, .tif, .tiff, .tga, .webp, .jpeg," +
    " .jpg, .gif, .pam, .pgm, .ppm, .xbm, .xpm, .dcm, .dicm, .dicom, .ima, .img";
            // 
            // progressBar
            // 
            ...
            this.Name = "frmConvertImage";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Convert images";
